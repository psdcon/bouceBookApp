...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2015 at 01:31 PM
...
CREATE TABLE IF NOT EXISTS `tariff_skills` (
  ...
  `skill` text NOT NULL,
  `shaped` int NOT NULL,
  `shape_bonus` real NOT NULL,
  `start_position` text NOT NULL,
  `end_position` text NOT NULL,
  `tariff` real NOT NULL,
  `fig_notation` text NOT NULL,
  `description` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=83 ;

CREATE TABLE IF NOT EXISTS `tariff_skills` (`id` int primary key,`order` real,`level` text,`skill` text,`shaped` int,`shape_bonus` real,`start_position` text,`end_position` text,`tariff` real,`fig_notation` text,`description` text);
